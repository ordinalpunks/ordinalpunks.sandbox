...
def mog( *attributes, id )
  ...
  if base.downcase.index( 'female')
    punk.compose!( Image.read( './more/mog-female.png') )
  else
    punk.compose!( Image.read( './more/mog-male.png') )
  end
  punk
end
...
ids.each do |id|
  ...
  punk = mog( *attributes, id )

  punk.save( "./tmp2/mog-#{id+1}.png" )
  punk.zoom(4).save( "./tmp2/mog-#{id+1}@4x.png" )
  punk.zoom(8).save( "./tmp2/mog-#{id+1}@8x.png" )

  composite << punk
end


composite.save( "./tmp/mogs.png" )
composite.zoom(4).save( "./tmp/mogs@4x.png" )
